...
public class comm_06 extends AppCompatActivity {
    TextView 飲_脂肪肝內文_TV;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comm_06);



        飲_脂肪肝內文_TV = findViewById(R.id.飲_脂肪肝內文_TV);
 ...
 */
        ...
        通_個人_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,Personal.class);
                startActivity(intent);
            }
        });
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        居_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        醫_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,MedicalCard.class);
                startActivity(intent);
            }
        });
        ...
        預_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        衛_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,edu_main.class);
                startActivity(intent);
            }
        });
        ...
        飲_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_06.this,commendMain.class);
                startActivity(intent);
            }
        });
