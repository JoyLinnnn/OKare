...
public class AlarmReceiver extends BroadcastReceiver {
    public static final String TYPE_ONE_TIME = "OKare回診提醒";
    public static final String TYPE_REPEATING = "OKare用藥提醒";
    ...
    private void showAlarmNotification(Context context,String title,String message,int notifiId){
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message){
        ...
        Toast.makeText(context, "一次性提醒設定成功 !", Toast.LENGTH_SHORT).show();
    }
    ...
    public void setRepeatingAlarm(Context context, String type, String time, String message){
        ...
        Toast.makeText(context, "重複性提醒設定成功 !", Toast.LENGTH_SHORT).show();
    }
