...
public class comm_04 extends AppCompatActivity {
    TextView 飲_痛風內文_TV;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comm_04);



        飲_痛風內文_TV = findViewById(R.id.飲_痛風內文_TV);
        // 資料若超過頁面，須設定可以Scrolling
        飲_痛風內文_TV.setMovementMethod(ScrollingMovementMethod.getInstance());

        // 讀取 raw folder 的檔案
        InputStreamReader isr = new InputStreamReader(this.getResources().openRawResource(R.raw.food_hurt));
...
/*        ImageButton 通_通知_IB=findViewById(R.id.通_通知_IB);
        通_通知_IB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,noti.class);
 ...
 */
        ...
        通_個人_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,Personal.class);
                startActivity(intent);
            }
        });
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        居_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        醫_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,MedicalCard.class);
                startActivity(intent);
            }
        });
        ...
        預_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        即_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,CurrentLocation.class);
                startActivity(intent);
            }
        });
        ...
        衛_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,edu_main.class);
                startActivity(intent);
            }
        });
        ...
        飲_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_04.this,commendMain.class);
                startActivity(intent);
            }
        });
