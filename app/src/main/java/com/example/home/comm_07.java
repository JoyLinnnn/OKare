...
/*        ImageButton 通_通知_IB=findViewById(R.id.通_通知_IB);
        通_通知_IB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,noti.class);
 ...
 */
        ...
        通_個人_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,Personal.class);
                startActivity(intent);
            }
        });
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        居_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        醫_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,MedicalCard.class);
                startActivity(intent);
            }
        });
        ...
        預_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        即_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,CurrentLocation.class);
                startActivity(intent);
            }
        });
        ...
        衛_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,edu_main.class);
                startActivity(intent);
            }
        });
        ...
        飲_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_07.this,commendMain.class);
                startActivity(intent);
            }
        });
