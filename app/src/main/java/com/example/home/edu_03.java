...
public class edu_03 extends AppCompatActivity {
    TextView 衛_糖尿病內文_TV;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edu_03);
...
/*        ImageButton 通_通知_IB=findViewById(R.id.通_通知_IB);
        通_通知_IB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,noti.class);
 ...
 */
        ...
        通_個人_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,Personal.class);
                startActivity(intent);
            }
        });
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        衛_居家檢測_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        衛_醫療小卡_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,MedicalCard.class);
                startActivity(intent);
            }
        });
        ...
        衛_衛教資訊_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,edu_main.class);
                startActivity(intent);
            }
        });
        ...
        衛_飲食推薦_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,commendMain.class);
                startActivity(intent);
            }
        });
        ...
        衛_預約掛號_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_03.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        衛_糖尿病內文_TV.setMovementMethod(ScrollingMovementMethod.getInstance());

        // 讀取 raw folder 的檔案
        InputStreamReader isr = new InputStreamReader(this.getResources().openRawResource(R.raw.candy));
        ...
        衛_糖尿病內文_TV.setText(sb.toString());
    }
}