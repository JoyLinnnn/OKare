...
public class comm_05 extends AppCompatActivity {
  ...
  */
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_05.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        預_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_05.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        即_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(comm_05.this,CurrentLocation.class);
                startActivity(intent);
            }
        });
