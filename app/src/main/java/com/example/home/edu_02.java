...
public class edu_02 extends AppCompatActivity {
    TextView 衛_慢性肺病內文_TV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        通_通知_IB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(edu_02.this,noti.class);
        ...
        通_個人_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_02.this,Personal.class);
                startActivity(intent);
            }
        });
        ...
        衛_即時定位_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_02.this,CurrentLocation.class);
                startActivity(intent);
            }
        });
        ...
        // 讀取 raw folder 的檔案
        InputStreamReader isr = new InputStreamReader(this.getResources().openRawResource(R.raw.slow));
        ...
        衛_慢性肺病內文_TV.setText(sb.toString());
    }
}