 ...
 */
        ...
        通_首頁_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,Homepage.class);
                startActivity(intent);
            }
        });
        ...
        衛_居家檢測_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        衛_醫療小卡_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,MedicalCard.class);
                startActivity(intent);
            }
        });
        ...
        衛_衛教資訊_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,edu_main.class);
                startActivity(intent);
            }
        });
        ...
        衛_飲食推薦_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,commendMain.class);
                startActivity(intent);
            }
        });
        ...
        衛_即時定位_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,CurrentLocation.class);
                startActivity(intent);
            }
        });
        ...
        衛_預約掛號_IB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(edu_04.this,ReserveHospital.class);
                startActivity(intent);
            }
        });
        ...
        // 讀取 raw folder 的檔案
        InputStreamReader isr = new InputStreamReader(this.getResources().openRawResource(R.raw.brain));
        ...
        衛_腦中風內文_TV.setText(sb.toString());
    }
}